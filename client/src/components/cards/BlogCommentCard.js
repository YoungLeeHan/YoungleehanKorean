...
import { colorPurple, colorYellow } from "../../constants/constant";
        ...
        <>
            <li className="d-flex flex-column justify-content-between">
                ...
                <h5>
                    ...
                    >
                        <BiLike
                            fill={comment?.isLiked ? colorYellow : colorPurple}
